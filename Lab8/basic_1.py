...
if __name__ == "__main__":
    ...
    X_train, X_test, y_train, y_test = train_test_split(df['CONTENT'], df['class'], random_state=42, test_size=0.3)
    ...
    X_vt_1, X_test_1, y_vt_1, y_test_1 = train_test_split(df['CONTENT'], df['class'], random_state=42,
    ...
    report = classification_report(y_test_1, predictions)

    macro_f1 = f1_score(y_test_1, predictions, average='macro')
